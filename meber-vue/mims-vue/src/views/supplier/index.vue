  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('stock:supplier:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('stock:supplier:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="qq" header-align="center" align="center" label="QQ">
      </el-table-column>
      <el-table-column prop="email" header-align="center" align="center" label="Email">
      </el-table-column>
      <el-table-column prop="openBank" header-align="center" align="center" label="银行账户开户行">
      </el-table-column>
      <el-table-column prop="bankAccount" header-align="center" align="center" label="银行账户">
      </el-table-column>
      <el-table-column prop="address" header-align="center" align="center" label="联系地址">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      API.supplier.list(params).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(",")}]进行[${id ? "删除" : "批量删除"}]操作?`, "提示", {
        ...
        API.supplier.del(ids).then(({ data }) => {
          if (data && data.code === 0) {
            this.$message({
              message: "操作成功",
              type: "success",
